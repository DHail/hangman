...
get '/' do
	...
	if params['make'] != nil
		...
		bad_guesses, good_guesses, word = my_game.get_word(make)
	elsif params['guess'] != nil
		guess = params['guess'].to_s
		bad_guesses, good_guesses, word = my_game.check_guess(guess)
	elsif params['game'] != nil
		game = params['game'].to_s
		bad_guesses, good_guesses, word = my_game.new_game
	end
